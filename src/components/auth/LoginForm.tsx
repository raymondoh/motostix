...
//   return (
//     <div className={`w-full px-0 ${className}`} {...props}>
...
//         <form id="login-form" onSubmit={handleSubmit} className="space-y-6 px-0">
...
//                 <span className="bg-background px-4 text-base text-muted-foreground">Or continue with</span>
//               </div>
//             </div>
//             <GoogleAuthButton mode="signin" className="mt-4 h-10" />
//           </div>
//         </form>
//       </div>
