...
//   // Highlight: New state variables for firstName, lastName, and displayName
//   const [firstName, setFirstName] = useState("");
//   const [lastName, setLastName] = useState("");
//   const [displayName, setDisplayName] = useState(""); // Renamed from 'name'
//   const [bio, setBio] = useState("");
//   const [photoURL, setPhotoURL] = useState<string | null>(null);
//   const [photoFile, setPhotoFile] = useState<File | null>(null);
//   const [formReady, setFormReady] = useState(false);
...
//   // Highlight: New initial state variables
//   const [initialFirstName, setInitialFirstName] = useState("");
//   const [initialLastName, setInitialLastName] = useState("");
//   const [initialDisplayName, setInitialDisplayName] = useState(""); // Renamed from 'initialName'
//   const [initialBio, setInitialBio] = useState("");
//   const [initialPhotoURL, setInitialPhotoURL] = useState<string | null>(null);
...
//   useEffect(() => {
//     if (status === "authenticated" && session?.user && !formReady) {
//       // Highlight: Initialize new state variables from session.user
//       setFirstName(session.user.firstName || "");
//       setLastName(session.user.lastName || "");
//       setDisplayName(session.user.displayName || session.user.name || ""); // Fallback for displayName
//       setBio(session.user.bio || "");
//       setPhotoURL(session.user.image || null);

//       // Highlight: Initialize initial state variables
//       setInitialFirstName(session.user.firstName || "");
//       setInitialLastName(session.user.lastName || "");
//       setInitialDisplayName(session.user.displayName || session.user.name || ""); // Fallback
//       setInitialBio(session.user.bio || "");
//       setInitialPhotoURL(session.user.image || null);
...
//   const resetForm = () => {
//     // Highlight: Reset new state variables
...
//   const handleCancel = () => {
//     if (!isPending && !isUploading) {
//       // Highlight: Check for changes in new state variables
//       const formChanged =
...
//     try {
//       const formData = new FormData();
//       // Highlight: Append new fields to formData
//       formData.append("firstName", firstName);
//       formData.append("lastName", lastName);
//       formData.append("displayName", displayName); // Use displayName here
//       formData.append("bio", bio);
...
//               <UserAvatar
//                 src={photoURL}
//                 name={session?.user?.name} // Keep this using session.user.name for now, or update it
//                 email={session?.user?.email}
//                 className="h-full w-full"
//               />
//             </Button>
...
//           {/* Highlight: New First Name, Last Name, and Display Name inputs */}
...
//           <UniversalInput
//             id="displayName" // Renamed from 'name'
//             label="Display Name" // Changed label
//             value={displayName}
//             onChange={setDisplayName}
//             variant="compact"
//             className="h-12 border-input dark:border-opacity-50 focus:ring-2 focus:ring-primary focus:border-primary"
//             placeholder="e.g., MotoStix Fan" // Optional placeholder
//           />
...
//             variant="compact"
//             className="h-12 bg-muted border border-gray-300 dark:border-gray-500 cursor-not-allowed opacity-50"
//             disabled // Explicitly disable it
//           />
