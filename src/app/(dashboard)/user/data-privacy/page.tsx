...
export default async function DataPrivacyPage() {
  ...
  return (
    <DashboardShell>
      {/* <DashboardHeader title="Data & Privacy" description="Manage your personal data and privacy settings" /> */}
      <DashboardHeader
        title="Data & Privacy"
        description="Manage your personal data and privacy settings"
        breadcrumbs={[{ label: "Home", href: "/" }, { label: "Dashboard", href: "/user" }, { label: "Data & Privacy" }]}
      />
